...
import 'package:weather_ui_api/display_weather.dart'; //to parse JSON data
...
class _WeatherUiState extends State<WeatherUi> {
  ...
  void getData() async {
    ...
    if (response.statusCode == 200) {
      ...
      // var cityName = decodeWeather['name'];
      // var countryName = decodeWeather['sys']['country'];
      // var description = decodeWeather['weather'][0]['description'];
      // print(description);
    } else {
      print(response.statusCode);
    }
